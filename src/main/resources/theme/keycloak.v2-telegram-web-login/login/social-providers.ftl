                  ...
                  <a data-once-link data-disabled-class="${properties.kcFormSocialAccountListButtonDisabledClass!}" id="social-${p.alias}"
                        ...
                        <#switch p.alias>
                            ...
                            <#case "paypal">
                                ...
                                <#break>
                            <#case "vkid">
                                <svg viewBox="10 8 30 30" aria-hidden="true">
                                    <path fill="#fff" d="M25.2,33.2c-9,0-14.1-6.1-14.3-16.4h4.5c0.1,7.5,3.5,10.7,6.1,11.3V16.8h4.2v6.5c2.6-0.3,5.3-3.2,6.2-6.5h4.2	c-0.7,4-3.7,7-5.8,8.2c2.1,1,5.5,3.6,6.7,8.2h-4.7c-1-3.1-3.5-5.5-6.8-5.9v5.9H25.2z"></path>
                                </svg>
                                <#break>
                            <#case "yandex">
                                <svg viewBox="-3.5 0 24 24" aria-hidden="true">
                                    <path fill="#000000" d="m5.2 24v-7.786l-5.2-13.964h2.616l3.834 10.767 4.41-13.018h2.405l-5.658 16.303v7.697z"/>
                                </svg>
                                <#break>
                            <#default>
                                <svg viewBox="0 0 512 512" aria-hidden="true">
